package com.st.fox.business.admin;
...
@ComponentScan(basePackages = { "com.st.fox.business.admin", "com.st.fox.core",
		"com.st.fox.business.commons.web", "com.st.fox.system.api" })
