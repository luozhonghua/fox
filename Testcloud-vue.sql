...
INSERT INTO `sys_admin_group` VALUES ('33', 'bom员工', '64,74,77,78,79,80,81,82,83,84,86,87', '0', 'bom系统所有权限', '1');
...
CREATE TABLE `sys_admin_menu` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=89 DEFAULT CHARSET=utf8 COMMENT='【配置】后台菜单表';
...
INSERT INTO `sys_admin_menu` VALUES ('85', '64', 'st系统配置', '', '', '1', '0', '1', '79', 'stbom', null, '    │    └─st系统管理2级菜单');
INSERT INTO `sys_admin_menu` VALUES ('86', '85', 'st菜单管理', '/home/menu/list', '', '1', '0', '1', '87', 'stbom', 'menu', '      └─st菜单列表');
INSERT INTO `sys_admin_menu` VALUES ('87', '64', 'st账户管理', '', '', '1', '0', '1', '77', 'stbom', null, '    │    ├─st账户管理2级菜单');
INSERT INTO `sys_admin_menu` VALUES ('88', '87', 'st账户列表', '/home/users/list', '', '1', '0', '1', '81', 'stbom', 'users', '    │    └─st成员列表');
...
INSERT INTO `sys_admin_rule` VALUES ('74', 'st管理菜单', 'menus', '2', '64', '1');
...
-- ----------------------------
INSERT INTO `sys_system_config` VALUES ('1', 'SYSTEM_NAME', 'ST通用中台系统', '0', '1');
